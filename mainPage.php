        ...
        <header>
            ...
            <div class="infoBar">
                <div class="info">
                    ...
                    ?></span>
                    <input id="name" 
                        value="<?php session_start();echo $_SESSION['loginName'];?>" 
                        size="<?php session_start();$length = mb_strlen($_SESSION['loginName']);echo $length>3?$length+1:$length;?>"
                        maxlength="8"
        ...
        <main>
            <aside>
                <ul id="showLogInfo">
                    ...
                    <?php
                        //连接数据库
                        include_once './main/api/database.php';
                        //查找数据
